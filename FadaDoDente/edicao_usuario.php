					...
					<form method="post" action="usuario_insert.php">
						<div class="form-group">
							<div class="row">
								<div style="padding-bottom: 2em;" class="col-md-12">
									<center><img src="images/icones_novos/cadastro_usuario.png" width="130" height="130"></center>
								</div>
								<div class="col-md-6">
								...
								<div class="col-md-6 grid_box1">
									<label style="padding-bottom: 8px;">E-Mail:</label><br>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-6">
									<label>Usuário:</label>
									<input style="border-radius: 5px;" type="text" class="form-control1" name="usuario" placeholder="Nome Completo" required="">
								</div>
								<div class="clearfix"> </div>
							</div>
						</div>
						<div class="form-group">
							<div  style="padding-bottom: 2em;" class="row">
								<div class="col-md-6 grid_box1">
									<label>Senha:</label>
									<input style="border-radius: 5px;" name="senha" type="password" class="form-control1" placeholder="Senha" required="">
								</div>
								<div class="col-md-6">
									<label>Confirmar Senha:</label>
									<input style="border-radius: 5px;" name="confirmarsenha" type="password" class="form-control1" placeholder="Confirmar Senha" required="">
								</div>
								<div class="clearfix"> </div>
							</div>
