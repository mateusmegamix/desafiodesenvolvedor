...
if(isset($_POST['acao'])){
	...
	if (!empty($foto["name"])) {
		...
		if (count($error) == 0) {
			...
			$sql->execute(array($nome, $email, $dataNoFormatoParaOBranco, $cpf, $rg, $cro, $especialidade, $salario, $estadocivil, $sexo, $idade, $cep, $rua, $bairro, $cidade, $estado, $numero, $complemento, $telefone, $celular, $caminho_imagem));
