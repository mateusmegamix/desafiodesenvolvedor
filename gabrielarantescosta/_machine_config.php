...
GlobalConfig::$CONNECTION_SETTING->DBName = "desafiodesenvolvedor";
...
/** the root url of the application with trailing slash, for example http://localhost/gabrielarantescosta/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'GabrielArantesCosta/';
...
if (GlobalConfig::$CONNECTION_SETTING->Multibyte && !function_exists('mb_strlen'))
	die('<html>As extensões de vários bytes não estão instaladas, mas o Multibyte está definido como true em _machine_config.php</html>');
