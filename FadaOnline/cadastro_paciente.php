    ...
    <div id="page-wrapper">
        <div class="graphs">
            <div class="md">
                ...
                <form method="post" enctype="multipart/form-data" action="insert_paciente.php">
                    ...
                    <div class="form-group">
                        <div  style="padding-bottom: 2em;" class="row">
                            <div class="col-md-12 grid_box1">
                                ...
                                <textarea rows="20" cols="50" style="border-radius: 5px;max-width: 100%;min-height: 150px;" type="text" class="form-control1" name="historia" placeholder="História Médica" required=""></textarea>
                            </div>
                            <div class="clearfix"> </div>
                        </div>
