    ...
    <div id="wrapper">
    	...
    	<nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-default sidebar" role="navigation">
                ...
                <center><a class="novaconsulta" href="cadastro_consulta.php"><i class="fas fa-plus-square"></i> Novo Usuário</a></center>
                <!-- /.sidebar-collapse -->
            </div>
            <!-- /.navbar-static-side -->
        </nav>
        <div id="page-wrapper">
            <div class="graphs">
                <div class="md">
                    <center><h3>Cadastro de Funcionários</h3></center>

                    <form method="post" enctype="multipart/form-data" action="insert_funcionarios.php">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <br>
                                    <input style="width: 78%;border-radius: 5px;" class="form-control1"  id="uploadFile" placeholder="Escolha o Arquivo" disabled="disabled" />
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-2 grid_box1">
                                    ...
                                    <input style="border-radius: 5px;" type="date" class="form-control1" name="nascimento" placeholder="" required="">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <label>Sexo:</label><br>
                                <select style="border-radius: 5px;" name="sexo" class="form-control1">
                            ...
                            <div class="col-md-2">
                                <label>Salário:</label>
                                <input style="border-radius: 5px;" name="salario" type="text" class="form-control1" required="" placeholder="Ex: 2.300,00">
                            </div>
                            <div class="col-md-4">
                                <label>Função:</label>
                                <input style="border-radius: 5px;" name="funcao" type="text" class="form-control1" required="">
                            </div>
                            <div  class="col-md-2">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                <label>Estado:</label>
                                <input style="border-radius: 5px;" value="" type="text" class="form-control1" name="estado" id="uf">
                            </div>
                            <div class="col-md-1">
                                <label>Número:</label>
